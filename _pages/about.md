...
I'm a final year PhD student in the Computer Science department at Oxford University. I work on translating computational advances to biological and healthcare data. I try to focus on areas where there is an unmet clinical need, either due to lack of effective methods or good data. I'm in the Intelligent Systems lab in CS, supervised by Prof Thomas Lukasiewicz, and on the clinical side I'm supervised by Prof Chunxiao Song at the Ludwig Institute of Cancer Research. Most of my PhD work has focused on computational epigenetics: analysing how genome-wide epigenetic patterns relate to patient phenotypes, and how this changes in diseases such as cancer. I adapt machine learning methods primarily from the NLP domain and apply them to biological sequences, primarily genomic and epigenomic datasets. My lab developed a new epigenetic sequencing method called [TAPS] (https://github.com/academicpages/academicpages.github.io), and I analysed the data produced in the [first pilot study] (https://www.science.org/doi/10.1126/sciadv.abh0534) of this method applied to cell-free DNA liquid biopsy. I've since focused on 
...
Before my PhD I studied Natural Sciences then for a Masters in Computational Biology, both from Cambridge University. I then worked for a year as a data scientist in a tech startup before embarking on my PhD. 
<!-- 
